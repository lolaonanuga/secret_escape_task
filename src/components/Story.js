            ...
            <div className="ui card" id="card"  style={{width: width+ 'rem', background: background}}>
                ...
                <div id={storyInfo.title} className="content">
                    ...
                    <div className="description" onClick={expand}>
                        ...
                        :
                            <Fragment>
                                <p>{fillerText.slice(0,100)}...Read more</p>
                            </Fragment>
                        }
                    </div> 
                    <div className="score">
                        <i data-testid={storyInfo.title} onClick={this.addScore} id="like" className="thumbs up outline icon"></i>
                        <p id="info" className="info">{score}</p>
                    </div>
                </div>    
                }
            </div>   
